...
public class SimpleShoot : MonoBehaviour
{
    ...
    public InputActionReference triggerButtonActionRef;
    bool isTriggerPressed = false;
    private void OnEnable()
    {
        if (triggerButtonActionRef == null) return;

        triggerButtonActionRef.action.Enable();

        triggerButtonActionRef.action.performed += OnTriggerPress;
    }
